...
void Laborator4::Update(float deltaTimeSeconds)
{
	...
	forRotateSun += 0.5f * deltaTimeSeconds;
	forRotateEarth += 2 * deltaTimeSeconds;
	forRotateMoon += 4 * deltaTimeSeconds;

	modelMatrix = glm::mat4(1);
	/*modelMatrix *= Transform3D::Translate(0, 0, 0);
	modelMatrix *= Transform3D::Translate(translateX, translateY, translateZ);*/
	modelMatrix *= Transform3D::Translate(5.5f, 0, 0);
	modelMatrix *= Transform3D::RotateOY(forRotateEarth);
	modelMatrix *= Transform3D::Translate(-5.5f, 0, 0);
	modelMatrix *= Transform3D::Translate(5.5f - radius1, 0, 0);

	modelMatrix *= Transform3D::RotateOY(forRotateSun);
	modelMatrix *= Transform3D::Scale(0.75f, 0.75f, 0.75f);

	RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);

	glm::vec4 pointEarth = modelMatrix * glm::vec4(0, 0, 0, 1);

	modelMatrix = glm::mat4(1);
	/*modelMatrix *= Transform3D::Translate(0, 0, 0);
	modelMatrix *= Transform3D::Scale(scaleX, scaleY, scaleZ);*/
	modelMatrix *= Transform3D::Translate(pointEarth[0], 0, pointEarth[2]);
	modelMatrix *= Transform3D::RotateOY(forRotateMoon);
	modelMatrix *= Transform3D::Translate(-pointEarth[0], 0, -pointEarth[2]);
	modelMatrix *= Transform3D::Translate(pointEarth[0] - radius2, 0, pointEarth[2] - radius2);
	modelMatrix *= Transform3D::RotateOY(forRotateSun);
	modelMatrix *= Transform3D::Scale(0.75f, 0.75f, 0.75f);
	...
	modelMatrix *= Transform3D::RotateOY(forRotateSun);
	modelMatrix *= Transform3D::Scale(1.25f, 1.25f, 1.25f);
	RenderMesh(meshes["box"], shaders["VertexNormal"], modelMatrix);
}
